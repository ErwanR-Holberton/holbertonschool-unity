...
<p>Throughout your development process, remember to frequently test your game and create development builds. While speed is essential, prioritize completing each task thoroughly before moving on to the next.</p>
...
<li>You may not use free or paid assets for this project</li>
  ...
  <input type="radio" name="6144" id="6144-1524609919385" value="1524609919385" data-quiz-answer-id="1524609919385" data-quiz-question-id="6144" disabled="disabled" checked="checked">
...
<p><img src="https://s3.eu-west-3.amazonaws.com/hbtn.intranet.project.files/holbertonschool-cs-unity/435/5.gif" alt="" loading="lazy" style=""></p>
...
<p><img src="https://s3.eu-west-3.amazonaws.com/hbtn.intranet.project.files/holbertonschool-cs-unity/435/10.gif" alt="" loading="lazy" style=""></p>
...
<p><img src="https://s3.eu-west-3.amazonaws.com/hbtn.intranet.project.files/holbertonschool-cs-unity/435/13.jpg" alt="" loading="lazy" style=""></p>
...
<div class="modal fade users-done-modal" id="task-20898-users-done-modal" data-task-id="20898" data-batch-id="395">
            ...
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="20900">Start a new test</button>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Students who are done with "3. Jump man"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
...
</div><div class="modal fade users-done-modal" id="task-20902-users-done-modal" data-task-id="20902" data-batch-id="395">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Students who are done with "4. Camera ready"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
...
</div><div class="modal fade task_correction_modal student_modal" id="task-test-correction-20902-correction-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Correction of "4. Camera ready"</h4>
            </div>
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="20902">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
                ...
                <div class="help">
    <button data-task-id="20902">
        <i aria-hidden="true" class="fa fa-info-circle "></i>
    </button>
    <div class="help-container" data-task-id="20902">
        <div class="check-line">
            <div class="check-inline requirement success">
                  <i aria-hidden="true" class="fa fa-check-circle "></i>
                Requirement success
...
</div><div class="modal fade users-done-modal" id="task-20903-users-done-modal" data-task-id="20903" data-batch-id="395">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Students who are done with "5. Steady cam"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
...
</div><div class="modal fade users-done-modal" id="task-20905-users-done-modal" data-task-id="20905" data-batch-id="395">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Students who are done with "6. Falling up"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
...
</div><div class="modal fade users-done-modal" id="task-20906-users-done-modal" data-task-id="20906" data-batch-id="395">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Students who are done with "7. Time trial"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
...
</div><div class="modal fade task_correction_modal student_modal" id="task-test-correction-20906-correction-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Correction of "7. Time trial"</h4>
            </div>
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="20906">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
                ...
                <div class="help">
    <button data-task-id="20906">
        <i aria-hidden="true" class="fa fa-info-circle "></i>
    </button>
    <div class="help-container" data-task-id="20906">
        <div class="check-line">
            <div class="check-inline requirement success">
                  <i aria-hidden="true" class="fa fa-check-circle "></i>
                Requirement success
...
</div><div class="modal fade users-done-modal" id="task-20907-users-done-modal" data-task-id="20907" data-batch-id="395">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Students who are done with "8. Clock's ticking"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
...
</div><div class="modal fade users-done-modal" id="task-20908-users-done-modal" data-task-id="20908" data-batch-id="395">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Students who are done with "9. Finish line"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
...
</div><div class="modal fade users-done-modal" id="task-20909-users-done-modal" data-task-id="20909" data-batch-id="395">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Students who are done with "10. The sky's the limit"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
...
</div><div class="modal fade users-done-modal" id="task-20910-users-done-modal" data-task-id="20910" data-batch-id="395">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Students who are done with "11. The great outdoors"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
...
</div><div class="modal fade users-done-modal" id="task-20911-users-done-modal" data-task-id="20911" data-batch-id="395">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Students who are done with "12. Environmental awareness"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
...
</div><div class="modal fade users-done-modal" id="task-20912-users-done-modal" data-task-id="20912" data-batch-id="395">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Students who are done with "13. What's left of the flag"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
...
</div><div class="modal fade users-done-modal" id="task-20913-users-done-modal" data-task-id="20913" data-batch-id="395">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Students who are done with "14. (Sea)horse race"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
...
</div><div class="modal fade task_correction_modal student_modal" id="task-test-correction-20913-correction-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Correction of "14. (Sea)horse race"</h4>
            </div>
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="20913">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
                ...
                <div class="help">
    <button data-task-id="20913">
        <i aria-hidden="true" class="fa fa-info-circle "></i>
    </button>
    <div class="help-container" data-task-id="20913">
        <div class="check-line">
            <div class="check-inline requirement success">
                  <i aria-hidden="true" class="fa fa-check-circle "></i>
                Requirement success
...
</div><div class="modal fade users-done-modal" id="task-20914-users-done-modal" data-task-id="20914" data-batch-id="395">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Students who are done with "15. Under development"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
