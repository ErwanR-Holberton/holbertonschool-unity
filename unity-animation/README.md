...
<p>In the <code>Animators</code> folder, create a new Animator named <code>ty.controller</code>. Drag the <code>Happy Idle</code> animation into the Animator tab and create a transition from the <code>Entry</code> state to the <code>Happy Idle</code> state.</p>
            ...
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="20967">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
...
<p>Add a new State called <code>Falling</code> inside the <code>FallingDown</code> Sub-state Machine. When the player is falling from a platform, whether they run off or jump off, the <code>Falling</code> animation should play until the player lands on the starting position again.</p>
...
<div>
  ...
  <div class="modal fade users-done-modal" id="task-20969-users-done-modal" data-task-id="20969" data-batch-id="395">
    <div class="modal-dialog">
        ...
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Students who are done with "9. Splat"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
      ...
      <button class="btn btn-default btn-sm" data-task-id="20969" data-toggle="modal" data-target="#task-test-correction-20969-correction-modal" id="task-num-9-check-code-btn">
          Review your work
      </button>
      <div class="modal fade task_correction_modal student_modal" id="task-test-correction-20969-correction-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Correction of "9. Splat"</h4>
            </div>
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="20969">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
                ...
                <div class="help">
    <button data-task-id="20969">
        <i aria-hidden="true" class="fa fa-info-circle "></i>
    </button>
    <div class="help-container" data-task-id="20969">
        <div class="check-line">
            <div class="check-inline requirement success">
                  <i aria-hidden="true" class="fa fa-check-circle "></i>
                Requirement success
        ...
        <div class="fs-4">
            <strong class="text-primary">
              <span id="task-20969-score-info-score">0</span>/10
            </strong>
            <span class="text-muted">pts</span>
        </div>
      </div>
    ...
    <div data-role="task20970" data-position="11" id="task-num-10">
      <div class="panel panel-default task-card " id="task-20970">
  <span id="user_id" data-id="6218"></span>
  ...
  <div class="panel-body">
    ...
    <!-- Task Body -->
    <p>Download <a href="https://s3.eu-west-3.amazonaws.com/hbtn.intranet.project.files/holbertonschool-cs-unity/animations/ty@Getting Up.fbx" title="this Animation Clip" target="_blank">this Animation Clip</a> and import it into your <code>Animations</code> folder.</p>

<p>Add a new State called <code>Getting Up</code>. Create a transition from <code>Falling Flat Impact</code> to <code>Getting Up</code> named <code>ImpactToGettingUp</code>. Create a transition from the <code>FallingDown</code> sub-state to <code>Idle</code> named <code>GettingUpToIdle</code>. This animation should play after the <code>Falling Flat Impact</code> animation finishes. This animation should play once and not repeat.</p>

<p><img src="https://s3.eu-west-3.amazonaws.com/hbtn.intranet/uploads/medias/2018/6/b1d5781111d84f7b3fe4.gif?X-Amz-Algorithm=AWS4-HMAC-SHA256&amp;X-Amz-Credential=AKIA4MYA5JM5DUTZGMZG%2F20240716%2Feu-west-3%2Fs3%2Faws4_request&amp;X-Amz-Date=20240716T084321Z&amp;X-Amz-Expires=86400&amp;X-Amz-SignedHeaders=host&amp;X-Amz-Signature=f34383bc185938df5c06191be7323d2c03dbd815d3abc521820f65fa1ca5c0a2" alt="" loading="lazy" style=""></p>
    ...
    <!-- Technical information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>holbertonschool-unity</code></li>
            <li>Directory: <code>unity-animation</code></li>
            <li>File: <code>Assets/Scenes/Level01.unity, Assets/Animations/ty@Getting Up.fbx, Assets/Animators/ty.controller</code></li>
        </ul>
      </div>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="20970" data-batch-id="395" data-toggle="modal" data-target="#task-20970-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-20970-users-done-modal" data-task-id="20970" data-batch-id="395">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Students who are done with "10. Down but not out"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
      ...
      <button class="btn btn-default btn-sm" data-task-id="20970" data-toggle="modal" data-target="#task-test-correction-20970-correction-modal" id="task-num-10-check-code-btn">
          Review your work
      </button>
      <div class="modal fade task_correction_modal student_modal" id="task-test-correction-20970-correction-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Correction of "10. Down but not out"</h4>
            </div>
            <div class="modal-body">
                <div class="actions">
                    <center>
                        ...
                        <button name="button" type="submit" class="btn btn-primary correction_request_test_send" data-task-id="20970">Start a new test</button>
                        <button class="btn btn-default close-modal hidden" data-dismiss="modal" type="button">Close</button>
                ...
                <div class="help">
    <button data-task-id="20970">
        <i aria-hidden="true" class="fa fa-info-circle "></i>
    </button>
    <div class="help-container" data-task-id="20970">
        <div class="check-line">
            <div class="check-inline requirement success">
                  <i aria-hidden="true" class="fa fa-check-circle "></i>
                Requirement success
        ...
        <div class="fs-4">
            <strong class="text-primary">
              <span id="task-20970-score-info-score">0</span>/10
            </strong>
            <span class="text-muted">pts</span>
        </div>
      </div>
    ...
    <div data-role="task20971" data-position="12" id="task-num-11">
      <div class="panel panel-default task-card " id="task-20971">
  <span id="user_id" data-id="6218"></span>
  ...
  <div class="panel-body">
    ...
    <!-- Task Body -->
    <p>Update the <code>Level02</code> and <code>Level03</code> scenes to have their own intro animations named <code>Intro02</code> and <code>Intro03</code> respectively. Replace the placeholder player with the animated model in each scene as well.</p>

<p>Some of the animations may not transition well or may clip through the floor or have other visual issues. Change the animations’ settings in the Inspector accordingly to adjust. (<a href="/rltoken/KpLapZXL-6zL_SiZzYfeZg" title="Hint" target="_blank">Hint</a>) You should also edit the transition times or animation length times to create smooth animations and a good player experience.</p>
    ...
    <!-- Technical information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>holbertonschool-unity</code></li>
            <li>Directory: <code>unity-animation</code></li>
            <li>File: <code>Assets/Scenes/Level02.unity, Assets/Scenes/Level03.unity, Assets/Animators/ty.controller, Assets/Animations/*.fbx, Assets/Animations/Intro02.anim, Assets/Animations/Intro03.anim</code></li>
        </ul>
      </div>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="20971" data-batch-id="395" data-toggle="modal" data-target="#task-20971-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-20971-users-done-modal" data-task-id="20971" data-batch-id="395">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Students who are done with "11. Animated features"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
        ...
        <div class="fs-4">
            <strong class="text-primary">
              <span id="task-20971-score-info-score">0</span>/12
            </strong>
            <span class="text-muted">pts</span>
        </div>
      </div>
    ...
    <div data-role="task20972" data-position="13" id="task-num-12">
      <div class="panel panel-default task-card " id="task-20972">
  <span id="user_id" data-id="6218"></span>
...
<li><code>Level02</code></li>
<li><code>Level03</code></li>
</ol>

<p>Create three builds of all scenes above in the <code>Builds</code> directory.</p>
      ...
      <div class="list-group-item">
        <div class="blog_post_div">
          ...
          <div class="input-group">
            <input id="input_20972" type="text" value="" class="form-control">
            <span class="input-group-btn">
              <button data-task-requesting="0" data-user-id="6218" data-task-id="20972" type="button" class="add_task_url btn btn-primary">
                Save
              </button>
            </span>
          </div>

          <div class="task_url_error_msg" data-task-id="20972"></div>

          <ol class="list_20972 sm-gap">
          </ol>
    ...
    <!-- Technical information -->
      <div class="list-group-item">
        ...
        <ul>
          <li>GitHub repository: <code>holbertonschool-unity</code></li>
            <li>Directory: <code>unity-animation</code></li>
            <li>File: <code>Assets/Builds/*</code></li>
        </ul>
      </div>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="20972" data-batch-id="395" data-toggle="modal" data-target="#task-20972-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-20972-users-done-modal" data-task-id="20972" data-batch-id="395">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Students who are done with "12. Not quite done yet"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
        ...
        <div class="fs-4">
            <strong class="text-primary">
              <span id="task-20972-score-info-score">0</span>/8
            </strong>
            <span class="text-muted">pts</span>
        </div>
      </div>
          ...
          <div class="gap">
  <div data-react-class="projects/ProjectReview" data-react-props="{&quot;correction&quot;:{&quot;statusURI&quot;:&quot;/corrections/824039/status_self_paced.json&quot;,&quot;startReviewURI&quot;:&quot;/corrections/824039/start_auto_review_self_paced.json&quot;},&quot;csrfToken&quot;:&quot;-wv7KVj19Q5s6OJtcSeMX6ayD92-lPwztitcqUHDjx3F50RFnR8bVWvpxSHdLAiaExKse711A1uGDr6426p5rA&quot;,&quot;nextProject&quot;:{&quot;details&quot;:{&quot;curriculum_completed&quot;:false,&quot;message&quot;:&quot;Next project: C# - Generics&quot;,&quot;uri&quot;:&quot;/projects/2291&quot;},&quot;fetchURI&quot;:&quot;/projects/2260/next&quot;},&quot;pollingInterval&quot;:10000,&quot;progress&quot;:{&quot;auto_review&quot;:{&quot;can_execute&quot;:true,&quot;completion&quot;:{&quot;count&quot;:0,&quot;is_completed&quot;:false,&quot;percentage&quot;:0.0},&quot;inability_to_execute_reason&quot;:null},&quot;tasks&quot;:[{&quot;id&quot;:20960,&quot;progress_score&quot;:{&quot;progress&quot;:0.0,&quot;score&quot;:0.0},&quot;score_info&quot;:{&quot;passed&quot;:false,&quot;points&quot;:2,&quot;score&quot;:0}},{&quot;id&quot;:20961,&quot;progress_score&quot;:{&quot;progress&quot;:0.0,&quot;score&quot;:0.0},&quot;score_info&quot;:{&quot;passed&quot;:false,&quot;points&quot;:5,&quot;score&quot;:0}},{&quot;id&quot;:20962,&quot;progress_score&quot;:{&quot;progress&quot;:0.0,&quot;score&quot;:0.0},&quot;score_info&quot;:{&quot;passed&quot;:false,&quot;points&quot;:9,&quot;score&quot;:0}},{&quot;id&quot;:20963,&quot;progress_score&quot;:{&quot;progress&quot;:0.0,&quot;score&quot;:0.0},&quot;score_info&quot;:{&quot;passed&quot;:false,&quot;points&quot;:4,&quot;score&quot;:0}},{&quot;id&quot;:20964,&quot;progress_score&quot;:{&quot;progress&quot;:0.0,&quot;score&quot;:0.0},&quot;score_info&quot;:{&quot;passed&quot;:false,&quot;points&quot;:9,&quot;score&quot;:0}},{&quot;id&quot;:20965,&quot;progress_score&quot;:{&quot;progress&quot;:0.0,&quot;score&quot;:0.0},&quot;score_info&quot;:{&quot;passed&quot;:false,&quot;points&quot;:4,&quot;score&quot;:0}},{&quot;id&quot;:20966,&quot;progress_score&quot;:{&quot;progress&quot;:0.0,&quot;score&quot;:0.0},&quot;score_info&quot;:{&quot;passed&quot;:false,&quot;points&quot;:8,&quot;score&quot;:0}},{&quot;id&quot;:20967,&quot;progress_score&quot;:{&quot;progress&quot;:0.0,&quot;score&quot;:0.0},&quot;score_info&quot;:{&quot;passed&quot;:false,&quot;points&quot;:8,&quot;score&quot;:0}},{&quot;id&quot;:20968,&quot;progress_score&quot;:{&quot;progress&quot;:0.0,&quot;score&quot;:0.0},&quot;score_info&quot;:{&quot;passed&quot;:false,&quot;points&quot;:10,&quot;score&quot;:0}},{&quot;id&quot;:20969,&quot;progress_score&quot;:{&quot;progress&quot;:0.0,&quot;score&quot;:0.0},&quot;score_info&quot;:{&quot;passed&quot;:false,&quot;points&quot;:10,&quot;score&quot;:0}},{&quot;id&quot;:20970,&quot;progress_score&quot;:{&quot;progress&quot;:0.0,&quot;score&quot;:0.0},&quot;score_info&quot;:{&quot;passed&quot;:false,&quot;points&quot;:10,&quot;score&quot;:0}},{&quot;id&quot;:20971,&quot;progress_score&quot;:{&quot;progress&quot;:0.0,&quot;score&quot;:0.0},&quot;score_info&quot;:{&quot;passed&quot;:false,&quot;points&quot;:12,&quot;score&quot;:0}},{&quot;id&quot;:20972,&quot;progress_score&quot;:{&quot;progress&quot;:0.0,&quot;score&quot;:0.0},&quot;score_info&quot;:{&quot;passed&quot;:false,&quot;points&quot;:8,&quot;score&quot;:0}}],&quot;summary&quot;:{&quot;completion&quot;:0.0,&quot;score&quot;:{&quot;mandatory&quot;:null,&quot;optional&quot;:null}},&quot;can_skip&quot;:true,&quot;can_start_peer_review&quot;:false},&quot;peerReview&quot;:{&quot;availableReviewersURI&quot;:&quot;/corrections/824039/available_reviewers.json&quot;,&quot;canReviewPeerDirectly&quot;:true,&quot;correctCorrectionURI&quot;:&quot;https://intranet.hbtn.io/corrections/824039/correct&quot;,&quot;qaReviewsURI&quot;:&quot;/corrections/to_review&quot;,&quot;readyForReviewURI&quot;:&quot;/corrections/824039/toggle_ready_for_review.json&quot;,&quot;reviewDeadline&quot;:null,&quot;synchronousManualReview&quot;:false},&quot;project&quot;:{&quot;completion&quot;:0.0,&quot;id&quot;:2260,&quot;index&quot;:0,&quot;isAccessible&quot;:true,&quot;isOptional&quot;:false,&quot;imagePath&quot;:&quot;/assets/pathway/003_color-0c5b38973bfe29fff8dd86f65a213ea2d2499a7d0d9e4549f440c50dc84c9618.png&quot;,&quot;name&quot;:&quot;Unity - Animation&quot;,&quot;score&quot;:{&quot;mandatory&quot;:null,&quot;optional&quot;:null},&quot;tasksCount&quot;:0},&quot;skipURI&quot;:&quot;/corrections/824039/skip&quot;,&quot;taskLevelReviewTypeHumanized&quot;:&quot;Your score will be updated as you progress.&quot;}" data-react-cache-id="projects/ProjectReview-0"><div class="panel panel-default"><div class="panel-heading"><h3 class="panel-title">Score</h3></div><div class="panel-body"><div class="align-items-center d-flex gap-5"><div class="pathway" style="padding: 10px 30px 40px;"><div class="project-circle " style="border-radius: 100%; box-shadow: rgb(229, 230, 230) 10px 20px 10px; height: 125px; margin: auto; padding: 5px; width: 125px;"><div data-test-id="CircularProgressbarWithChildren"><div style="position: relative; width: 100%; height: 100%;"><svg class="CircularProgressbar " viewBox="0 0 100 100" data-test-id="CircularProgressbar" style="height: 115px; vertical-align: middle; width: 115px;"><path class="CircularProgressbar-trail" d="
      M 50,50
      m 0,-48.5
      a 48.5,48.5 0 1 1 0,97
      a 48.5,48.5 0 1 1 0,-97
